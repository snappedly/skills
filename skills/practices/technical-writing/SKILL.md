...
description: "Layered technical-writing standard: Diátaxis structure, Google developer style sentences, STE instruction rules, Global English syntax. Use for /technical-writing, docs, RFCs, readmes, PR descriptions, commit messages, and every ticket or issue being drafted, created, or reviewed."
---
...
- Apply the **remove-slop** skill to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
- Apply this skill whenever you create a ticket or issue, including planning specs, decision tickets, and executable work items. Review the title and body before publishing.
