...
Pinned copy of the Vercel Web Interface Guidelines, read by the [`frontend-guidelines`](SKILL.md) skill.
...
- Licence: MIT, (c) Vercel Labs

Everything below the rule is upstream text, with the slash-command frontmatter and its `$ARGUMENTS` line removed. `SKILL.md` carries the refresh command.
